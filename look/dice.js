...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-9eba0fe5');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-9eba0fe5');}
...
function clearFlash(){dieView.classList.remove('rl-win-9eba0fe5');dieView.classList.remove('rl-lose-9eba0fe5');if(frameEl){frameEl.classList.remove('rl-win-9eba0fe5');frameEl.classList.remove('rl-lose-9eba0fe5');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-9eba0fe5');if(frameEl){frameEl.classList.add('rl-win-9eba0fe5');}}else{dieView.classList.add('rl-lose-9eba0fe5');if(frameEl){frameEl.classList.add('rl-lose-9eba0fe5');}}
...
var brandEl=document.querySelector('.rl-brand-9eba0fe5');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
